...
#--     # Entry Asistencia, aproximacion de aistencia.
        ...
        label_Aprox_Asistencia.pack(fill= tk.X, padx= 70)
        label_Aprox_Asistencia.place(x= 350, y= 110)
        #---------------
        ...
        label_Aprox_Asistencia.pack(fill= tk.X, padx= 70)
        label_Aprox_Asistencia.place(x= 70, y= 210)
        #---------------
        ...
        self.Nombre_archivo.place(x= 70, y= 240)
        #---------------
        # Ejecuta la ventana.
        #---------------
