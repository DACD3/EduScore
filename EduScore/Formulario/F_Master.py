...
class MasterPanel:
    ...
    def SendEmail(self, frame):
        ...
        #en caso de agregar un archivo usa este codigo
        #yag.send(destinatarios, asunto,[mensaje,hatm],attachments=[archivo, 'nombre del archivo'])
    #---------------
    # inicia la ventana 
    #---------------    
    def __init__(self):        
        ...
        #--------------
        boton_Correo = tk.Button(frame_master, text= "Mandar calificaciones", font= ("Gidole Regular", 15), bd= 2, relief= "solid", bg = '#777777', fg= 'black', command= lambda:self.SendEmail(farme_descripcion))
